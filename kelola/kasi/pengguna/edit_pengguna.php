	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
                ...
                if ($data_cek['level'] == "Kasi Pemerintahan") echo "<option value='Kasi Pemerintahan' selected>Kasi Pemerintahan</option>";
                else echo "<option value='Kasi Pemerintahan'>Kasi Pemerintahan</option>";

                if ($data_cek['level'] == "RT") echo "<option value='RT' selected>RT</option>";
                else echo "<option value='RT'>RT</option>";

                if ($data_cek['level'] == "Kepala Desa") echo "<option value='Kepala Desa' selected>Kepala Desa</option>";
                else echo "<option value='Kepala Desa'>Kepala Desa</option>";
            ?>
					</select>
				</div>
			</div>
