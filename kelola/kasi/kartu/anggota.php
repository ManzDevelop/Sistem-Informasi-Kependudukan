				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<select name="id_pend" id="id_pend" class="form-control select2bs4" required>
							<option value="" selected disabled>- Penduduk -</option>
							<?php
					...
					<div class="col-sm-3">
						<select name="hubungan" id="hubungan" class="form-control select2bs4" required>
							<option value="" selected disabled>- Hub Keluarga -</option>
